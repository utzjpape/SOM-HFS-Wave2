...
merge 1:1 strata ea block hh using "${gsdData}/1-CleanTemp/hh_hhm.dta", nogen assert(match) keepusing(penrol penrol_p penrol_s pgender pworking_age no_children no_adults no_old_age pliteracy hhh_gender hhh_age hhh_edu lfp_7d_hh emp_7d_hh hhh_lit hhh_outstate)

...
qui tabout separated_roster t using "${gsdOutput}/Raw_Fig11.xls", svy  percent c(col lb ub) npos(col) append h1("Separated") f(4) 
...
qui tabout hhm_unite t using "${gsdOutput}/Raw_Fig11.xls", svy  percent c(col lb ub) npos(col) append h1("ReuniteAccess") f(4) 
...
merge m:1 strata ea block hh using "${gsdData}/1-CleanTemp/hh_all_idpanalysis.dta", keepusing(weight_adj comparisonidp genidp quintileidp reasonidp urbanrural t tc_imp quintiles_tc) assert(match using)
...
qui tabout t using "${gsdOutput}/Raw_Fig11.xls", svy sum c(mean numsep lb ub se) npos(col) append h2("NumberSeparated") f(4) 
...
qui tabout hhm_sep_sex t using "${gsdOutput}/Raw_Fig11.xls", svy percent c(col lb ub) npos(col) append h1("GenderSeparated") f(4) 
...
qui tabout t using "${gsdOutput}/Raw_Fig11.xls", svy sum c(mean hhm_sep_age lb ub se) npos(col) append h2("AgeSeparated") f(4) 

*Contact
qui tabout comparisonidp using "${gsdOutput}/Raw_Fig11.xls", svy sum c(mean hhm_sep_contact lb ub se) npos(col) append h2("ContactSeparated") f(4) 
qui tabout genidp using "${gsdOutput}/Raw_Fig11.xls", svy sum c(mean hhm_sep_contact lb ub se) npos(col) append h2("ContactSeparated") f(4) 
qui tabout quintileidp using "${gsdOutput}/Raw_Fig11.xls", svy sum c(mean hhm_sep_contact lb ub se) npos(col) append h2("ContactSeparated") f(4) 
qui tabout reasonidp using "${gsdOutput}/Raw_Fig11.xls", svy sum c(mean hhm_sep_contact lb ub se) npos(col) append h2("ContactSeparated") f(4) 
qui tabout urbanrural using "${gsdOutput}/Raw_Fig11.xls", svy sum c(mean hhm_sep_contact lb ub se) npos(col) append h2("ContactSeparated") f(4) 
qui tabout t using "${gsdOutput}/Raw_Fig11.xls", svy sum c(mean hhm_sep_contact lb ub se) npos(col) append h2("ContactSeparated") f(4) 
...
qui tabout hhm_sep_reason t using "${gsdOutput}/Raw_Fig11.xls", svy percent c(col lb ub) npos(col) append h1("ReasonSeparated") f(4) 
...
qui tabout hhm_sep_relation t using "${gsdOutput}/Raw_Fig11.xls", svy percent c(col lb ub) npos(col) append h1("Relationship") f(4) 

...
save "${gsdTemp}/mi_est_rev_1.dta", replace


********************************************************************
*Include the poverty line and obtain the poverty status
********************************************************************
use "${gsdTemp}/mi_est_rev_1.dta", clear
...
save "${gsdData}/1-CleanTemp/mi-analysis_rev_1.dta", replace
...
use "${gsdData}/1-CleanTemp/mi-analysis_rev_1.dta", clear
forvalues i = 1/`nmi' {
	use "${gsdData}/1-CleanTemp/mi-analysis_rev_1.dta", clear
	mi extract `i', clear	
	gen mi = `i'
	save "${gsdTemp}/mi_`i'_rev_1.dta", replace
}
*append
clear
forvalues i = 1/`nmi' {
...
keep strata ea block hh weight hhsize deflator hhweight plinePPP plinePPP_rev tc_imp poorPPP_prob poorPPP_rev_prob pgi pgi_rev ind_profile severity severity_rev
save "${gsdData}/1-CleanTemp/hhq-poverty_rev_1.dta", replace

...
* Comparison model 1: exclude quartile information
********************************************************************
...
save "${gsdData}/1-CleanTemp/hhq-poverty_comparison1.dta", replace

* Comparison Model 2: Assign JL to to Central Regions instead; with quartile information
********************************************************************
*Define the number of imputations
********************************************************************
local n = 100
...
********************************************************************
* Change aggregation 
recode ind_profile (4=2) (9=7), gen(ind_profile_impute)
gen rural=hh_ptype==2
local model = "hhsize pchild psenior i.hhsex i.hhempl hhedu i.hh_type i.hh_drinkwater i.hh_floor i.hh_ownership i.ind_profile_impute rural i.hh_hunger i.remit12m"
...
label var mi_cons_d "Durable consumption pc pd curr USD"
save "${gsdData}/1-CleanTemp/hhq-poverty_comparison2.dta", replace

* Comparison model 3: Jubaland to Central Regions; no quartiles, regional dummy
********************************************************************
*Define the number of imputations
********************************************************************
local n = 100
...
label var mi_cons_d "Durable consumption pc pd curr USD"
save "${gsdData}/1-CleanTemp/hhq-poverty_comparison3.dta", replace

* Comparison Model 2: Baseline model (from 1-8-2 Do file), but without rural dummy
********************************************************************
*Define the number of imputations
********************************************************************
local n = 100
...
* Change aggregation 
recode ind_profile (4=2) (9=11), gen(ind_profile_impute)
local model = "hhsize pchild psenior i.hhsex i.hhempl hhedu i.hh_type i.hh_drinkwater i.hh_floor i.hh_ownership i.ind_profile_impute i.hh_hunger i.remit12m"
local model = "i.pmi_cons_f0 i.pmi_cons_nf0 i.pmi_cons_d `model'"
*Create core consumption for comparison
save "${gsdData}/1-CleanTemp/mi-pre.dta", replace
*Run imputation
...
label var mi_cons_d "Durable consumption pc pd curr USD"
save "${gsdData}/1-CleanTemp/hhq-poverty_comparison4.dta", replace
...
merge 1:1 strata ea block hh using "${gsdData}/1-CleanTemp/hhq-poverty_comparison1.dta", nogen assert(match) keepusing(poorPPP poorPPP_prob)
ren (poorPPP poorPPP_prob) (poorPPP1 poorPPP_prob1)
merge 1:1 strata ea block hh  using "${gsdData}/1-CleanTemp/hhq-poverty_comparison2.dta", nogen assert(match) keepusing(poorPPP poorPPP_prob)
ren (poorPPP poorPPP_prob) (poorPPP2 poorPPP_prob2)
merge 1:1 strata ea block hh using "${gsdData}/1-CleanTemp/hhq-poverty_comparison3.dta", nogen assert(match) keepusing(poorPPP poorPPP_prob)
ren (poorPPP poorPPP_prob) (poorPPP3 poorPPP_prob3)
merge 1:1 strata ea block hh using "${gsdData}/1-CleanTemp/hhq-poverty_comparison4.dta", nogen assert(match) keepusing(poorPPP poorPPP_prob)
ren (poorPPP poorPPP_prob) (poorPPP4 poorPPP_prob4)
svy: mean poorPPP_prob0, over(ind_profile)
svy: mean poorPPP_prob1, over(ind_profile)
svy: mean poorPPP_prob2, over(ind_profile)
svy: mean poorPPP_prob3, over(ind_profile)

...
* Model 4a: JL to SW, PL rural to PL urban; with quartile information + include rural dummy
********************************************************************
...
********************************************************************
* Change aggregation 
recode ind_profile (4=2) (9=11)
gen rural = hh_ptype==2
local model = "hhsize pchild psenior i.hhsex i.hhempl hhedu i.hh_type i.hh_drinkwater i.hh_floor i.hh_ownership i.ind_profile rural i.hh_hunger i.remit12m"
...
save "${gsdData}/1-CleanTemp/hhq-poverty4a.dta", replace

* Model 5a: JL to SW, PL rural to PL urban; no quartile information + rural dummy
********************************************************************
*Define the number of imputations
********************************************************************
local n = 100
...
label var mi_cons_d "Durable consumption pc pd curr USD"
save "${gsdData}/1-CleanTemp/hhq-poverty5a.dta", replace


* Model 6a: JL to CR; PL rural to PL urban; with quartile information + rural dummy
********************************************************************
*Define the number of imputations
********************************************************************
local n = 100
...
label var mi_cons_d "Durable consumption pc pd curr USD"
save "${gsdData}/1-CleanTemp/hhq-poverty6a.dta", replace


* Model 7a: JL to CR; PL rural with PL urban; no quartiles + rural dummy
********************************************************************
*Define the number of imputations
********************************************************************
local n = 100
...
label var mi_cons_d "Durable consumption pc pd curr USD"
save "${gsdData}/1-CleanTemp/hhq-poverty7a.dta", replace


* Merge it all together and create output to check poverty rates
use "${gsdData}/1-CleanOutput/hh.dta", clear
gen pweight=weight*hhsize
svyset ea [pweight=pweight], strata(strata)
ren (poorPPP poorPPP_prob) (poorPPP0 poorPPP_prob0)
merge 1:1 strata ea block hh using "${gsdData}/1-CleanTemp/hhq-poverty4.dta", nogen assert(match) keepusing(poorPPP poorPPP_prob)
ren (poorPPP poorPPP_prob) (poorPPP4 poorPPP_prob4)
merge 1:1 strata ea block hh  using "${gsdData}/1-CleanTemp/hhq-poverty5.dta", nogen assert(match) keepusing(poorPPP poorPPP_prob)
ren (poorPPP poorPPP_prob) (poorPPP5 poorPPP_prob5)
merge 1:1 strata ea block hh using "${gsdData}/1-CleanTemp/hhq-poverty6.dta", nogen assert(match) keepusing(poorPPP poorPPP_prob)
ren (poorPPP poorPPP_prob) (poorPPP6 poorPPP_prob6)
merge 1:1 strata ea block hh using "${gsdData}/1-CleanTemp/hhq-poverty4a.dta", nogen assert(match) keepusing(poorPPP poorPPP_prob)
ren (poorPPP poorPPP_prob) (poorPPP4a poorPPP_prob4a)
merge 1:1 strata ea block hh using "${gsdData}/1-CleanTemp/hhq-poverty5a.dta", nogen assert(match) keepusing(poorPPP poorPPP_prob)
ren (poorPPP poorPPP_prob) (poorPPP5a poorPPP_prob5a)
merge 1:1 strata ea block hh using "${gsdData}/1-CleanTemp/hhq-poverty6a.dta", nogen assert(match) keepusing(poorPPP poorPPP_prob)
ren (poorPPP poorPPP_prob) (poorPPP6a poorPPP_prob6a)
merge 1:1 strata ea block hh using "${gsdData}/1-CleanTemp/hhq-poverty7a.dta", nogen assert(match) keepusing(poorPPP poorPPP_prob)
ren (poorPPP poorPPP_prob) (poorPPP7a poorPPP_prob7a)
svy: mean poorPPP_prob4, over(ind_profile)
svy: mean poorPPP_prob5, over(ind_profile)
svy: mean poorPPP_prob6, over(ind_profile)
svy: mean poorPPP_prob7, over(ind_profile)
svy: mean poorPPP_prob4a, over(ind_profile)
svy: mean poorPPP_prob5a, over(ind_profile)
svy: mean poorPPP_prob6a, over(ind_profile)
svy: mean poorPPP_prob7a, over(ind_profile)

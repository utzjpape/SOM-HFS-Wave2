...
* Model 4: JL to SW, PL rural to PL urban; with quartile information
********************************************************************
...
local model = "hhsize pchild psenior i.hhsex i.hhempl hhedu i.hh_type i.hh_drinkwater i.hh_floor i.hh_ownership i.ind_profile i.hh_hunger i.remit12m"
...
save "${gsdData}/1-CleanTemp/hhq-poverty4.dta", replace

* Model 5: JL to SW, PL rural to PL urban; no quartile information
********************************************************************
*Define the number of imputations
********************************************************************
local n = 100
...
label var mi_cons_d "Durable consumption pc pd curr USD"
save "${gsdData}/1-CleanTemp/hhq-poverty5.dta", replace

set seed 23081985 
set sortseed 11041985

* Model 6: JL to CR; PL rural to PL urban; with quartile information
********************************************************************
*Define the number of imputations
********************************************************************
local n = 100
...
label var mi_cons_d "Durable consumption pc pd curr USD"
save "${gsdData}/1-CleanTemp/hhq-poverty6.dta", replace


* Model 7: JL to CR; PL rural with PL urban; no quartiles
********************************************************************
*Define the number of imputations
********************************************************************
local n = 100
...
label var mi_cons_d "Durable consumption pc pd curr USD"
save "${gsdData}/1-CleanTemp/hhq-poverty7.dta", replace
